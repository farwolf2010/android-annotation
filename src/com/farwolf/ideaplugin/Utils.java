...
public class Utils {
     ...
     * @return
     */
    public static ArrayList<IdBean> getIDsFromLayout(final PsiFile file) {
        final ArrayList<IdBean> elements = new ArrayList<IdBean>();
     ...
     * @return
     */
    public static ArrayList<IdBean> getIDsFromLayout(final PsiFile file, final ArrayList<IdBean> elements) {
        file.accept(new XmlRecursiveElementVisitor() {
            ...
            public void visitElement(final PsiElement element) {
                ...
                if (element instanceof XmlTag) {
                    ...
                    try {
                        elements.add(new IdBean(name, value));
